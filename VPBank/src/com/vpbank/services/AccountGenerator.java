	...
	public static long genAccountNumberBasic(Client c) {
		...
		if ((remainder == 0) && (accountNumberBasic != 0))
			...
			do {
				...
				default:
					accountNumArray[0] = 1;// in case of (accountNumberBasic ==
											// 0)
				}
				remainder = 0;
				for (int i = 0; i < accountNumArray.length; i++) {
	...
	public static int genAccountNumberPrefix(int start) {
		...
		if (remainder == 0)
			...
			do {
				...
				case 2: {
					// increase with 9
					accountNumArray[1] = (byte) (++accountNumArray[1] % 10);// with
																			// 5
					accountNumArray[3] = (byte) (++accountNumArray[3] % 10);// with
																			// 4
					break;
				}
				case 3:
				...
				case 4: {
					...
					accountNumArray[1] = (byte) (++accountNumArray[1] % 10);// with
																			// 5
					accountNumArray[4] = (byte) (++accountNumArray[4] % 10);// with
																			// 2
					break;
				}
				case 5: {
				...
				case 8: {
					// increase with 3
					accountNumArray[5] = (byte) (++accountNumArray[5] % 10);// with
																			// 1
					accountNumArray[4] = (byte) (++accountNumArray[4] % 10);// with
																			// 2
					break;
